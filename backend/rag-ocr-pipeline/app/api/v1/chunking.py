...
from app.db.mongodb import get_document_record, update_chunking_status
from app.models.chunking import DocumentChunkRequest, DocumentChunkResponse

from app.services.rag.chunking import chunk_document_and_store
from app.services.rag.dictionary import run_dictionary_auto_learning

router = APIRouter(prefix="/api/v1", tags=["chunking"])
logger = logging.getLogger(__name__)


@router.post("/chunk/document", response_model=DocumentChunkResponse, summary="Chunk OCR document and store to ChromaDB")
